...
const sendTaxFileReject = async (toEmail, acknowledgement_no, reason) => {

    const mailsubject = "Sorry! You Tax file was Failed";
    const html = await readFileAsync('./taxfilereject.html', 'utf-8');
...
module.exports = sendTaxFileReject;
