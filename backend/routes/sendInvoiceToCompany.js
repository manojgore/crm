...
const sendInvoiceToCompany = async (toEmail, buyer_name, invoice_number, invoice_subtotal, gst, invoice_total, ship_to_address, products) => {
    let allProducts = [];
...
module.exports = sendInvoiceToCompany;
