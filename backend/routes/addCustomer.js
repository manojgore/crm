...
router.post("/addCustomer", (req, res) => {
    const { owner_id, name, number, email, phone, gstNumber, panNo, addressLine1, addressLine2, county, city, state, pincode, bankName, branch,  accountHolderName, accountNumber, ifsc, image } = req.body;
