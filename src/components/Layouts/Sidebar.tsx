                ...
                <div className="bg-white dark:bg-black h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-120px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/purchase-plan">
                                    <button type="button" className={`${currentMenu === 'purchase-plan' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('purchase-plan')}>
                                        <div className="flex items-center">
                                            <IconCrown className="group-hover:!text-primary shrink-0" />
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Purchase Plan')}</span>
                                        </div>
                                    </button>
                                </NavLink>
                            </li>
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="nav-item">
                                        <NavLink to="/add-vendor" className="group">
                                            <div className="flex items-center">
                                                <IconVendor className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Add Vendors')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/vendors" className="group">
                                            <div className="flex items-center">
                                                <IconVendor className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Vendors')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                </ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/add-item" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Add Items')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/items" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Items')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                </ul>
