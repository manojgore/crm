                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        <div id="myTabContent" className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                            <div className={activeIndex === 1 ? '' : 'hidden' }>
                                <img src='/images/blog/01.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="shadow dark:shadow-gray-700 rounded-md" alt=""/>
                            ...
                            <div className={activeIndex === 2 ? '' : 'hidden' }>
                                <img src='/images/blog/02.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="shadow dark:shadow-gray-700 rounded-md" alt=""/>
                            ...
                            <div className={activeIndex === 3 ? '' : 'hidden' }>
                                <img src='/images/blog/03.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="shadow dark:shadow-gray-700 rounded-md" alt=""/>
